...
dataR = pd.read_csv(r"C:\Users\USER\Downloads\GlobalImpact-Covid19\data\Consumption_data.csv", sep=',', skiprows=4, header=None)
...
layout = html.Div(children=[
    html.Br(),
    html.H2("Impact of Covid-19 on Consumption", className="fw-bold text-center"),
    html.Br(),
